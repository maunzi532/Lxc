...
public class U
{
	...
	public static void init()
	{
		...
		put("XN-Schaden", new QLUpgrade(100, 50, 5, 1));
		put("XN-Speed", new EndUpgrade(100, 100, 5, 20, 5));
		put("XN-Akku", new QLUpgrade(100, 40, 200, 10));
		put("XN-Bereit", new QLUpgrade(50, 20, 2, 1));
		put("XN-Feuerrate", new QLUpgrade(100, 100, 1, 0.1));
		put("XN-Nachladen", new QLUpgrade(100, 100, 0.3, 0.05));

		put("FPL-Schaden", new QLUpgrade(100, 50, 3, 1));
		...
		put("FPL-FuelZeit", new EndUpgrade(100, 100, 100, 1, 5));

		put("S4-Schaden", new QLUpgrade(100, 50, 60, 5));
		put("S4-Speed", new EndUpgrade(100, 100, 10, 40, 5));
		put("S4-Munition", new QLUpgrade(100, 100, 6, 1));
		put("S4-Feuerrate", new EndUpgrade(100, 200, 20, 1, 5));
		put("S4-Auf", new EndUpgrade(100, 100, 50, 1, 5));
		put("S4-Rein", new EndUpgrade(100, 100, 20, 1, 5));
		put("S4-Zu", new EndUpgrade(100, 100, 20, 1, 5));

		put("CHY-Schaden", new QLUpgrade(100, 50, 40, 5));
		put("CHY-Speed", new EndUpgrade(100, 100, 5, 15, 5));
		put("CHY-Cooldown", new EndUpgrade(100, 200, 20, 1, 5));

		put("Tausch", new EndUpgrade(100, 100, 20, 0, 5));
	}
